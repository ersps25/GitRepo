...
public class MessageService extends Service implements SinchClientListener {
    ...
    private static final String APP_KEY = "7831c2d4-8215-4c40-be4c-561ee72aa3c9";
    private static final String APP_SECRET = "6dqjMk7VrUmMOcecZWuemA==";
    private static final String ENVIRONMENT = "sandbox.sinch.com";
    private final MessageServiceInterface serviceInterface = new MessageServiceInterface();
    private SinchClient sinchClient = null;
    private MessageClient messageClient = null;
    private String currentUserId;
    private Intent broadcastIntent = new Intent("chatapp.com.chatapplication.UsersList");
